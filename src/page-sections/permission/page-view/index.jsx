...
export default function PermissionPageView() {
  return <RoleBasedGuard roles={['editor', 'administrator', 'admin']}>
      <Typography variant="body2">
        ...
        facere, distinctio voluptatem iusto sequi odit at quia illo veniam totam ipsum consequuntur?
        Nostrum necessitatibus mollitia, nam eveniet pariatur, eius non saepe minus laudantium
        blanditiis sed voluptate aut placeat recusandae distinctio? Nisi suscipit dolorum itaque
        nostrum dolorem fugiat repellat ea ut necessitatibus!
      </Typography>
    </RoleBasedGuard>;
}