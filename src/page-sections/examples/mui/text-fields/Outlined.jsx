  ...
  return <Masonry columns={{
    ...
    xs: 1
      ...
      <Block title="With Adornment">
        <Stack spacing={3}>
          <TextField size="medium" label="With Normal TextField" id="outlined-start-adornment" slotProps={{
          input: {
            startAdornment: <InputAdornment position="start">kg</InputAdornment>
          }
        }} />

          <TextField size="medium" label="Password" type={visiblePassword ? 'text' : 'password'} slotProps={{
          input: {
          ...
          <TextField size="medium" label="Password" defaultValue="123456" type={visiblePassword ? 'text' : 'password'} slotProps={{
          input: {
            endAdornment: <IconButton onClick={handlePasswordVisibleToggle} sx={{
              p: 0
            }}>
      ...
      <Block title="Select">
        <Stack spacing={3}>
          ...
          <TextField select size="medium" defaultValue="EUR" label="Native select" slotProps={{
          select: {
            native: true
          }
        }}>
